...
OPENAPI_SPEC = {
    ...
    "paths": {
        ...
        "/users/{user_id}": {
            ...
            "put": {"tags": ["Users"], "summary": "Replace user fields", "parameters": [{"name": "user_id", "in": "path", "required": True, "schema": {"type": "string"}}], "requestBody": {"required": True, "content": {"application/json": {"schema": {"type": "object"}}}}, "responses": {"200": {"description": "OK"}}},
            "patch": {"tags": ["Users"], "summary": "Partial update user", "parameters": [{"name": "user_id", "in": "path", "required": True, "schema": {"type": "string"}}], "requestBody": {"required": True, "content": {"application/json": {"schema": {"$ref": "#/components/schemas/UserUpdateRequest"}}}}, "responses": {"200": {"description": "OK"}}},
        ...
        "/companies": {"get": {"tags": ["Companies"], "summary": "List companies", "responses": {"200": {"description": "OK"}}}, "post": {"tags": ["Companies"], "summary": "Create company", "requestBody": {"required": True, "content": {"application/json": {"schema": {"$ref": "#/components/schemas/CompanyCreateRequest"}}}}, "responses": {"201": {"description": "Created"}, "400": {"description": "admin_email is required"}}}},
        "/companies/{company_id}": {"get": {"tags": ["Companies"], "summary": "Get company", "parameters": [{"name": "company_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "OK"}}}, "patch": {"tags": ["Companies"], "summary": "Update company", "parameters": [{"name": "company_id", "in": "path", "required": True, "schema": {"type": "string"}}], "requestBody": {"required": True, "content": {"application/json": {"schema": {"$ref": "#/components/schemas/CompanyUpdateRequest"}}}}, "responses": {"200": {"description": "OK"}}}, "delete": {"tags": ["Companies"], "summary": "Deactivate company", "parameters": [{"name": "company_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "OK"}}}},
        ...
        "/trainings": {"get": {"tags": ["Trainings"], "summary": "List trainings", "responses": {"200": {"description": "OK"}}}, "post": {"tags": ["Trainings"], "summary": "Create training", "requestBody": {"required": True, "content": {"application/json": {"schema": {"$ref": "#/components/schemas/TrainingCreateRequest"}}}}, "responses": {"201": {"description": "Created"}}}},
        "/trainings/{training_id}": {"get": {"tags": ["Trainings"], "summary": "Get training", "parameters": [{"name": "training_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "OK"}}}, "patch": {"tags": ["Trainings"], "summary": "Update training", "parameters": [{"name": "training_id", "in": "path", "required": True, "schema": {"type": "string"}}], "requestBody": {"required": True, "content": {"application/json": {"schema": {"$ref": "#/components/schemas/TrainingUpdateRequest"}}}}, "responses": {"200": {"description": "OK"}}}, "delete": {"tags": ["Trainings"], "summary": "Deactivate training", "parameters": [{"name": "training_id", "in": "path", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "OK"}}}},
